          ...
          <section key={type} className="border border-border rounded bg-surface p-3">
            ...
            <DataTable
              columns={[
                ...
                { key: "change_pct_1d", label: "1D%", align: "right" },
                { key: "change_pct_1w", label: "1W%", align: "right" },
                { key: "change_pct_1m", label: "1M%", align: "right" },
                { key: "change_pct_3m", label: "3M%", align: "right" },
                { key: "change_pct_1y", label: "1Y%", align: "right" },
                { key: "change_pct_5y", label: "5Y%", align: "right" },
